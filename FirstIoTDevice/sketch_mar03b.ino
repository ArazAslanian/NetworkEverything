...
unsigned int myPort = 5083;      // local port to listen on
unsigned int remoteServerPort = 7083;  // remote port to talk to
IPAddress remoteServerAddress(192, 168, 1, 13); 
...
//// Actuators
//const int NUMBER_OF_ACTUATORS = 1;
...
boolean ledState;
boolean lastledState = LOW; // arbitrary
